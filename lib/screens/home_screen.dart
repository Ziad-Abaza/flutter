...
import 'package:my_app/widgets/ads_banner.dart';
import 'package:my_app/widgets/card_slider.dart';
import 'package:my_app/widgets/custom_list_view.dart';
            ...
            child: SingleChildScrollView(
              child: Column(
                ...
                children: [
                  ...
                  const AdBanner(),
                  const SizedBox(height: 20),
                  const Text("Featured", style: CustomTextStyle),
                  ...
                  Row(
                    ...
                    children: [
                      const Text("Promoted products", style: CustomTextStyle),
                      IconButton(
                          onPressed: () {
                  ...
                  Row(
                    mainAxisAlignment: MainAxisAlignment.spaceBetween,
                    children: [
                      const Text("Trending Product", style: CustomTextStyle),
                      IconButton(
                          onPressed: () {
                            Navigator.pushNamed(context, '/notfound');
                          },
